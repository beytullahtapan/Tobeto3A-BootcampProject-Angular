...
export class HomepageComponent implements OnInit{
 ...
 getListModels(){
    this.httpClient.get<DataResult<GetlistBootcampResponse[]>>("http://localhost:5001/api/Bootcamps")
    .subscribe({
  ...
  getListModels1(){
    this.httpClient.get<GetlistBootcampstateResponse[]>("http://localhost:5001/api/BootcampStates")
    .subscribe({
